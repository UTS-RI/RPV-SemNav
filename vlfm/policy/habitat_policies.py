...
class HabitatMixin:
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        action_space = kwargs.pop("action_space", None)  # Action space is needed to initiaise the parent class in Habitat v0.3.X, but we don't actually use it in our policies
    ...
    @classmethod
    # observation_space and action_space parameters need to be explicitly named in the signature, can't be captured from *args_unused
    def from_config(cls, config: DictConfig, observation_space: Any, action_space: Any,*args_unused: Any, **kwargs_unused: Any) -> "HabitatMixin":
        # Habitat_Baselines v0.3.X update: policy.main_agent instead of policy (reflected in yaml config file)
        ...
        kwargs["action_space"] = action_space   # Action space is needed to initiaise the parent class in Habitat v0.3.X
